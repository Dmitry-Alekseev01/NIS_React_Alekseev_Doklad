...
export const selectTask = createAction('[Task] Select Task', props<{ id: number }>());

export const addTask = createAction('[Task] Add Task', props<{ task: Partial<Task> }>());
...
export const updateTask = createAction('[Task] Update Task', props<{ id: number; changes: Partial<Task> }>());
